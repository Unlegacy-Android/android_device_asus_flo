...
PRODUCT_COPY_FILES += \
	...
	device/asus/flo/wifi/init.flo.wifi.sh:system/vendor/bin/init.flo.wifi.sh \
...
PRODUCT_COPY_FILES += \
	device/asus/flo/bluetooth/init.flo.bt.sh:system/vendor/bin/init.flo.bt.sh
...
PRODUCT_COPY_FILES += \
	...
	device/asus/flo/audio/audio_policy_configuration.xml:system/vendor/etc/audio_policy_configuration.xml \
